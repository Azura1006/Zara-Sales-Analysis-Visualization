...
with tab1:
    ...
    with col1:
        ...
        st.caption("The higher average sales of jackets, shoes, and sweaters indicate that these categories are Zara’s core high-performing product lines.")
    ...
    with col2:
        ...
        st.caption("Given that jackets accounted for over half of total sales in this sample, this distribution may reflect limitations in the dataset rather than Zara's actual category composition.")
    ...
    st.caption("Best-selling products are concentrated within a very narrow sales range, indicating that no single item in the high-end product line overwhelmingly outperforms others.")

# ==================== TAB 2: PRODUCT POSITION ANALYSIS ====================
with tab2:
    col1, col2 = st.columns(2)
    ...
    with col1:
        ...
        st.caption("Products displayed at the front of the store have slightly higher average sales, indicating a visibility advantage over aisles and end-cap placements.")
    ...
    with col2:
        ...
        st.caption("The distribution chart indicates that the sales coverage of the three locations is generally similar, but the upper limit of products displayed at the storefront is slightly higher than that at the aisle and end-cap display positions.")
    ...
    fig_heatmap = px.imshow(
        heatmap_data,
        title="Promotion vs Product Position (Average Sales)",
        labels=dict(x="Product Position", y="Promotion", color="Average Sales"),
        color_continuous_scale="YlGnBu",
        text_auto=True
    )
    st.plotly_chart(fig_heatmap, use_container_width=True)
    st.caption("The heat-map shows that promotions boost average sales across all product positions, with the greatest sales increase observed for end-cap placements.")
...
with tab3:
    ...
    with col1:
        ...
        st.caption("The scatter plot shows that sales volume remains relatively stable across prices below 200, but drops noticeably for higher-priced items.")
    
    with col2:
        # Sales volume distribution histogram
        ...
        st.caption("Sales distribution spans a broad range, with most products concentrated in the medium to higher sales volume segment.")
    ...
    st.caption("The box plot indicates that jackets have the highest median price and the widest overall price range, including several high-end outliers. T-shirts also exhibit a relatively broad price range, but their median remains distinctly lower.")

# ==================== TAB 4: PROMOTION & SEASONAL EFFECTS ====================
with tab4:
    col1, col2 = st.columns(2)
    ...
    with col1:
        ...
        st.caption("The chart shows that the average sales of promotional items are modestly higher, indicating that promotional activities have a mildly positive effect on sales.")
    ...
    with col2:
        ...
        st.caption("Average sales are slightly higher for non-seasonal items, suggesting that regular items sell more consistently than seasonal ones.")
...
with tab5:
    ...
    with col1:
        ...
        st.caption("The average sales volume for women's products is slightly higher than that for men's products, indicating a modestly stronger per-item performance in the women’s segment.")
    ...
    with col2:
        ...
        st.caption("The product distribution is heavily weighted toward men’s products, with men's products making up the majority of the product assortment.")
